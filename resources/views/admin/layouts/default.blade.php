...
<header>
	...
	<nav class="top-menu">
		...
		<div class="user-menu">
			...
			<div><a href="{{ route('logout') }}"><span class="fa fa-sign-out"></span>&nbsp;LogOut</a></div>
		</div>
	</nav>
</header>
@yield('content')
...
<div class="confirm-popup">
	...
	<div class="confirm-controls-wrap">
		<div>
			<button name="yes" class="button" type="button">Yes</button>
		</div>
		<div>
			<button name="no" class="button" type="button">No</button>
		</div>
	</div>
</div>
...
<div class="overview-popup">
	...
	<div class="form-button-wrap">
		<button name="addImageFromSaved" class="button" type="button">Apply</button>
	</div>
</div>
